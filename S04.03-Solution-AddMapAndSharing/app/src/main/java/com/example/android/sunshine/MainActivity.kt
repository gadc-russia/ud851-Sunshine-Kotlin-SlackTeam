...
import com.example.android.sunshine.R.id.action_map
import com.example.android.sunshine.R.id.action_refresh
import com.example.android.sunshine.R.layout.activity_forecast
import com.example.android.sunshine.R.menu.forecast
...
class MainActivity : AppCompatActivity(), ForecastAdapterOnClickHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(activity_forecast)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(forecast, menu)
