...
import com.example.android.sunshine.data.resetLocationCoordinates
import com.example.android.sunshine.sync.startImmediateSync
...
class SettingsFragment : PreferenceFragmentCompat(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        ...
        if (key == getString(R.string.pref_location_key)) {
            ...
            activity.contentResolver.notifyChange(WeatherContract.CONTENT_URI, null)
        }
