...
import com.example.android.sunshine.utilities.formatTemperature
import com.example.android.sunshine.utilities.getFormattedWind
...
class DetailActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.data == null) throw NullPointerException("URI for DetailActivity cannot be null")
        mUri = intent.data
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        ...
        val humid = data.getFloat(INDEX_WEATHER_HUMIDITY)
        val humidityString = getString(R.string.format_humidity, humid)
        ...
        val press = data.getFloat(INDEX_WEATHER_PRESSURE)
         ...
         * pressure.
         */
        val pressureString = getString(R.string.format_pressure, press)
