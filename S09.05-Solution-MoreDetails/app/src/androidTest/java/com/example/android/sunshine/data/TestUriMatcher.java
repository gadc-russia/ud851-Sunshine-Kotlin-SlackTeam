...
public class TestUriMatcher {
    ...
    private static final Uri TEST_WEATHER_DIR = WeatherContract.Companion.getCONTENT_URI();
    private static final Uri TEST_WEATHER_WITH_DATE_DIR = WeatherContract.Companion.buildWeatherUriWithDate(TestUtilities.DATE_NORMALIZED);
