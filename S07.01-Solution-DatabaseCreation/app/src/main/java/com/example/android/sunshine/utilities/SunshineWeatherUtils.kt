...
object SunshineWeatherUtils {
     ...
     * @param temperatureParam Temperature in degrees Celsius (°C)
     *
     * @return Formatted temperature String in the following form:
     * "21°"
     */
    fun formatTemperature(context: Context, temperatureParam: Double): String {
        var temperature = temperatureParam
     ...
     *
     * @param context   Android Context to access preferences and resources
     * @param windSpeedParam Wind speed in kilometers / hour
     ...
     */
    fun getFormattedWind(context: Context, windSpeedParam: Float, degrees: Float): String {
        var windSpeed = windSpeedParam
    ...
    fun getLargeArtResourceIdForWeatherCondition(weatherId: Int): Int {
        ...
        when (weatherId) {
            in 200..232 -> return R.drawable.art_storm
            in 300..321 -> return R.drawable.art_light_rain
            in 500..504 -> return R.drawable.art_rain
            511 -> return R.drawable.art_snow
            in 520..531 -> return R.drawable.art_rain
            in 600..622 -> return R.drawable.art_snow
            in 701..761 -> return R.drawable.art_fog
            761, 771, 781 -> return R.drawable.art_storm
            800 -> return R.drawable.art_clear
            801 -> return R.drawable.art_light_clouds
            in 802..804 -> return R.drawable.art_clouds
            in 900..906 -> return R.drawable.art_storm
            in 958..962 -> return R.drawable.art_storm
            in 951..957 -> return R.drawable.art_clear
        }
